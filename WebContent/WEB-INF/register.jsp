...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/checkUname.js">
</script>
</head>
...
<table width="70%" border="0" cellspacing="2" class="upline">
  ...
  <tr>
    ...
    <td><input type="password" class="textinput" name="cpassword"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style="text-align:right">性别：</td>
    <td colspan="2">&nbsp;&nbsp;<input type="radio" name="radiobutton" value="男" />
      男
...
女</td>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" class="textinput" name="tel"/></td>
  </tr>
  <tr>
    <td style="text-align:right">发货地址：</td>
    <td colspan="2"><input type="text" class="textinput" style="width:350px" name="address"/></td>
    </tr>
  <tr>
...
<table width="70%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td width="47%" style="width:50%"><select name="getselect" class="textinput" style="width:230px; height:20px">
...
<option value="您的第一辆汽车或自行车是什么牌子的？" >您的第一辆汽车或自行车是什么牌子的？</option>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" class="textinput" name="anser"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <font color="#999999">不能少于4个字符，不区分大小写</font></td>
    </tr>
    <tr>
    <td style="text-align:right">备用邮箱：</td>
    <td><input type="text" class="textinput" name="debug"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
...
<table width="80%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:27%"><input type="text" class="textinput"/></td>
    <td style="text-align: left"><img id="imgchange" src="${pageContext.request.contextPath }/imageServlet.do"/></a></td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
    <td>&nbsp;</td>
...
<table width="70%" border="0" cellspacing="0">
  <tr>
    <td style="padding-top:20px; text-align:center"><input type="image" src="${pageContext.request.contextPath }/images/signup.gif"/></td>
  </tr>
</table></td>
    </tr>
</table>
